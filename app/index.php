...
$routes = [
    [ "name" => "Tabulation"      , "route" => "/bato-min-dlc"          ],
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >bato-min-dlc</h1>
                <p class="fst-italic" >DLC and Minorettes Competition (Elementary Level)</p>
            </div>
